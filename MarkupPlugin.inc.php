...
class MarkupPlugin extends GenericPlugin {
	...
	/**
	 * This hook intercepts user request on public site to download/view an article galley HTML / XML / PDF link.  
	 *
	 * @param $hookName string
	...
	/**
	 * This method skips handling xml and pdf docs.  It displays HTML file with relative urls modified to reference plugin location for article's media.
	 *
	 * @param $hookName string
	 * @param $params array [$galleyId]
	 * @param $backLinkFlag boolean If true, iframe injected with link back to referring page.
	 *
	 **/
